		...
		<div class="ass1-head-user">
			<div class="ass1-head-user__content">
				<div class="ass1-head-user__image">
					<a href="#"><img src="/dist/images/cat-1634369_1920.jpg" alt="" /></a>
				</div>
				<div class="ass1-head-user__info">
					<div class="ass1-head-user__info-head">
						...
						<a
							...
							>Đổi mật khẩu</a
						>
						<a href="profile.html" class="ass1-head-user__btn-follow ass1-btn"
							>Profile</a
						>
					...
					<div class="ass1-head-user__info-statistic">
						<div class="ass1-btn-icon">
							<i class="icon-Post"></i><span>Bài viết: 9999</span>
						</div>
						<div class="ass1-btn-icon">
				...
				<div class="ass1-section">
					...
					<div class="ass1-section__footer">
						...
						<a href="#" class="ass1-section__btn-comment ass1-btn-icon"
							><i class="icon-Comment_Full"></i><span>982</span></a
						>
					</div>
				</div>
			</div>
